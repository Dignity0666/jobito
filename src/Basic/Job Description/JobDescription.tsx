...
const MAX_CHARS = { description: 500, responsibilities: 500, whoYouAre: 500, niceToHave: 350 };
...
function RichEditor({ placeholder, maxChars, small, value, onChange, id }) {
