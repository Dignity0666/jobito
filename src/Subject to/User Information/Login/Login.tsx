        ...
        <div className={Style.centeredBox}>
          <div className={Style.header}>
            ...
            <h2 className={Style.title}>
              {isResetMode ? t("Reset Password") : t("Welcome Back")}
            </h2>
            {!isResetMode && (
          ...
          {!isResetMode ? (
            <AnimatePresence mode="wait">
              ...
              >
                ...
                <div className={Style.inputGroup}>
                  ...
                  <div className={Style.relativeInput}>
                    <input
                      ...
                      required
                    />
                    <button type="button" className={Style.hideBtn}>Hide</button>
                  </div>
                ...
                >
                  {isLoggingIn ? <LoaderIcon className="loader" /> : "Login"}
                </button>

                <div className={Style.footerLink}>
                  Don't have an account? <button type="button" onClick={() => setShowLogin(false)}>Sign Up</button>
                </div>
              </motion.form>
            </AnimatePresence>
          ) : (
            <AnimatePresence mode="wait">
               {/* Reset flow simplified for space, similar to login */}
               <motion.div className={Style.form} initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
                  <button onClick={resetState} className={Style.backBtn}>Back to Login</button>
               </motion.div>
            </AnimatePresence>
          )}
        </div>
